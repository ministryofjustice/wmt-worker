...
module.exports = function () {
  ...
  config.VALID_SHEET_NAMES.forEach(function (sheet) {
    ...
    const worksheet1DataAsJSON = XLSX.utils.sheet_to_json(worksheet1, { raw: false, defval: null })
    const worksheet2DataAsJSON = XLSX.utils.sheet_to_json(worksheet2, { raw: false, defval: null })
