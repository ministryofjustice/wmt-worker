exports.seed = function (knex, Promise) {
  var view = `CREATE VIEW app.omic_ldu_capacity_view
    WITH SCHEMABINDING
    AS
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_ldu_capacity_view
  ON app.omic_ldu_capacity_view (id, workload_report_id)`

  var disable = "ALTER INDEX idx_omic_ldu_capacity_view ON app.omic_ldu_capacity_view DISABLE;"
  var enable = "ALTER INDEX idx_omic_ldu_capacity_view ON app.omic_ldu_capacity_view REBUILD;"

  return knex.schema
             .raw('DROP VIEW IF EXISTS app.omic_ldu_capacity_view;')
