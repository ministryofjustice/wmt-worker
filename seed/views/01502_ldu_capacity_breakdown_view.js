exports.seed = function (knex, promise) {
  var view = `CREATE VIEW app.omic_ldu_capacity_breakdown_view
    WITH SCHEMABINDING
    AS
    SELECT
      l.id AS id
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_ldu_capacity_breakdown_view
  ON app.omic_ldu_capacity_breakdown_view (link_id, grade_code)`

  var disable = "ALTER INDEX idx_omic_ldu_capacity_breakdown_view ON app.omic_ldu_capacity_breakdown_view DISABLE;"
  var enable = "ALTER INDEX idx_omic_ldu_capacity_breakdown_view ON app.omic_ldu_capacity_breakdown_view REBUILD;"

  return knex.schema
      .raw('DROP VIEW IF EXISTS app.omic_ldu_capacity_breakdown_view;')
