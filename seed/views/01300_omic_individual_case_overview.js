exports.seed = function (knex, promise) {
  var view = `CREATE VIEW app.omic_individual_case_overview
  WITH SCHEMABINDING
  AS
  SELECT
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_individual_case_overview
  ON app.omic_individual_case_overview (workload_owner_id)`

  var disable = "ALTER INDEX idx_omic_individual_case_overview ON app.omic_individual_case_overview DISABLE;"
  var enable = "ALTER INDEX idx_omic_individual_case_overview ON app.omic_individual_case_overview REBUILD;"

  return knex.schema
    .raw('DROP VIEW IF EXISTS app.omic_individual_case_overview;')
