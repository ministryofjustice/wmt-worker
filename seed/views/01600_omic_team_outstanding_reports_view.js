exports.seed = function (knex, Promise) {
  var sql = `CREATE VIEW app.omic_team_outstanding_reports_view
    WITH SCHEMABINDING
    AS
    SELECT
        wo.team_id AS id
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_team_outstanding_reports_view
    ON app.omic_team_outstanding_reports_view(link_id, grade_code)`

  var disable = "ALTER INDEX idx_omic_team_outstanding_reports_view ON app.omic_team_outstanding_reports_view DISABLE;"
  var enable = "ALTER INDEX idx_omic_team_outstanding_reports_view ON app.omic_team_outstanding_reports_view REBUILD;"

  return knex.schema
    .raw('DROP VIEW IF EXISTS app.omic_team_outstanding_reports_view;')
