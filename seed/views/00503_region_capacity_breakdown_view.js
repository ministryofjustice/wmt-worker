exports.seed = function (knex, promise) {
  const view = `CREATE VIEW app.region_capacity_breakdown_view
    WITH SCHEMABINDING
    AS
    SELECT 
      r.id AS id
  ...
  const index = `CREATE UNIQUE CLUSTERED INDEX idx_region_capacity_breakdown_view
  ON app.region_capacity_breakdown_view (link_id, grade_code)`
