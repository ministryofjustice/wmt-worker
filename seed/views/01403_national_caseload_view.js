exports.seed = function (knex, Promise) {
  var sql = `CREATE VIEW app.omic_national_caseload_view
        WITH SCHEMABINDING
        AS
  SELECT
      r.id AS link_id
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_national_caseload_view
  ON app.omic_national_caseload_view (link_id, location, grade_code)`

  var disable = "ALTER INDEX idx_omic_national_caseload_view ON app.omic_national_caseload_view DISABLE;"
  var enable = "ALTER INDEX idx_omic_national_caseload_view ON app.omic_national_caseload_view REBUILD;"

  return knex.schema
      .raw('DROP VIEW IF EXISTS app.omic_national_caseload_view;')
