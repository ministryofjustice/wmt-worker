exports.seed = function (knex, Promise) {
  var view = `CREATE VIEW app.omic_ldu_caseload_view
  WITH SCHEMABINDING
  AS
  SELECT
      t.ldu_id AS id
  ...
  var index = `CREATE UNIQUE CLUSTERED INDEX idx_omic_ldu_caseload_view
  ON app.omic_ldu_caseload_view (link_id, location, grade_code)`

  var disable = "ALTER INDEX idx_omic_ldu_caseload_view ON app.omic_ldu_caseload_view DISABLE;"
  var enable = "ALTER INDEX idx_omic_ldu_caseload_view ON app.omic_ldu_caseload_view REBUILD;"

  return knex.schema
    .raw('DROP VIEW IF EXISTS app.omic_ldu_caseload_view;')
