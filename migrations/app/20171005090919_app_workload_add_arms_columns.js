exports.up = function (knex, promise) {
  var sql = 'ALTER TABLE app.workload ADD arms_community_cases INT NOT NULL CONSTRAINT workload_arms_community_default DEFAULT 0;'
...
exports.down = function (knex, Promise) {
  var sql = 'ALTER TABLE app.workload DROP CONSTRAINT workload_arms_community_default;'
