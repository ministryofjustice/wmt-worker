exports.up = function (knex, Promise) {
  var sql = 'ALTER TABLE app.workload_points_calculations ADD t2a_workload_points_id INT;'
...
exports.down = function (knex, Promise) {
  var sql = 'ALTER TABLE app.workload_points_calculations DROP CONSTRAINT workload_points_calculations_t2a_workload_points_id_foreign;'
