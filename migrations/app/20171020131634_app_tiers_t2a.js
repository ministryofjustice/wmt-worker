exports.up = function (knex, promise) {
  let sql = 'ALTER TABLE app.tiers ADD t2a_overdue_terminations_total INT NOT NULL CONSTRAINT tiers_t2a_overdue_terminations_total_default DEFAULT 0;'
...
exports.down = function (knex, Promise) {
  let sql = 'ALTER TABLE app.tiers DROP CONSTRAINT tiers_t2a_overdue_terminations_total_default;'
