...
exports.up = function (knex, Promise) {
  return knex.schema.createTable('workload_points', function (table) {
    ...
    table.integer('comm_tier_8').unsigned().notNullable()
    table.integer('comm_tier_9').unsigned().notNullable()
    table.integer('comm_tier_10').unsigned().notNullable()
    table.integer('comm_tier_11').unsigned().notNullable()
    table.integer('comm_tier_12').unsigned().notNullable()
    table.integer('comm_tier_13').unsigned().notNullable()
    table.integer('comm_tier_14').unsigned().notNullable()
    table.integer('comm_tier_15').unsigned().notNullable()
    table.integer('comm_tier_16').unsigned().notNullable()
    ...
    table.integer('cust_tier_8').unsigned().notNullable()
    table.integer('cust_tier_9').unsigned().notNullable()
    table.integer('cust_tier_10').unsigned().notNullable()
    table.integer('cust_tier_11').unsigned().notNullable()
    table.integer('cust_tier_12').unsigned().notNullable()
    table.integer('cust_tier_13').unsigned().notNullable()
    table.integer('cust_tier_14').unsigned().notNullable()
    table.integer('cust_tier_15').unsigned().notNullable()
    table.integer('cust_tier_16').unsigned().notNullable()
    ...
    table.integer('lic_tier_8').unsigned().notNullable()
    table.integer('lic_tier_9').unsigned().notNullable()
    table.integer('lic_tier_10').unsigned().notNullable()
    table.integer('lic_tier_11').unsigned().notNullable()
    table.integer('lic_tier_12').unsigned().notNullable()
    table.integer('lic_tier_13').unsigned().notNullable()
    table.integer('lic_tier_14').unsigned().notNullable()
    table.integer('lic_tier_15').unsigned().notNullable()
    table.integer('lic_tier_16').unsigned().notNullable()
    ...
    table.integer('weighting_arms_lic').unsigned()
    table.integer('weighting_arms_comm').unsigned()
    table.boolean('is_t2a').notNullable()
