...
exports.up = function (knex, Promise) {
  const sql = 'ALTER TABLE app.user_role DROP CONSTRAINT user_role_last_updated_by_foreign;' +
...
exports.down = function (knex, Promise) {
  try {
    const sql = 'ALTER TABLE app.user_role ALTER COLUMN last_updated_by int; ALTER TABLE app.user_role ALTER COLUMN last_updated_by int NULL;' +
