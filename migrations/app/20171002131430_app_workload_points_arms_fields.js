exports.up = function (knex, promise) {
  var sql = 'ALTER TABLE app.workload_points ADD weighting_arms_lic INT CONSTRAINT weighting_arms_lic_default DEFAULT 0;'
...
exports.down = function (knex, Promise) {
  var sql = 'ALTER TABLE app.workload_points DROP CONSTRAINT weighting_arms_lic_default;'
