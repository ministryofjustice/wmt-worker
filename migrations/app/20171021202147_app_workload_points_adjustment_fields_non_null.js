exports.up = function (knex, Promise) {
  let sql = 'UPDATE app.workload_points_calculations SET gs_adjustment_points = 0 WHERE gs_adjustment_points IS NULL;'
...
exports.down = function (knex, Promise) {
  let sql = 'ALTER TABLE app.workload_points_calculations DROP CONSTRAINT wpc_cms_adjustment_points_default;'
  sql += 'ALTER TABLE app.workload_points_calculations DROP CONSTRAINT  wpc_gs_adjustment_points_default;'
