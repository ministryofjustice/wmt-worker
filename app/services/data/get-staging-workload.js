...
module.exports = function (range) {
  return knex('wmt_extract').whereBetween('wmt_extract.id', range)
    ...
    'wmt_extract.commtierf', 'wmt_extract.commtiere', 'wmt_extract.commtierd2',
    ...
    'wmt_extract.licencetier0', 'wmt_extract.licencetierg', 'wmt_extract.licencetierf',
    'wmt_extract.licencetiere', 'wmt_extract.licencetierd2', 'wmt_extract.licencetierd1',
    ...
    'wmt_extract.custtierg', 'wmt_extract.custtierf', 'wmt_extract.custtiere',
    ...
    'wmt_extract_filtered.commtierg AS filtered_commtierg', 'wmt_extract_filtered.commtierf AS filtered_commtierf',
    'wmt_extract_filtered.commtiere AS filtered_commtiere', 'wmt_extract_filtered.commtierd2 AS filtered_commtierd2',
    ...
    'wmt_extract_filtered.licencetier0 AS filtered_licencetier0', 'wmt_extract_filtered.licencetierg AS filtered_licencetierg', 'wmt_extract_filtered.licencetierf AS filtered_licencetierf',
    'wmt_extract_filtered.licencetiere AS filtered_licencetiere', 'wmt_extract_filtered.licencetierd2 AS filtered_licencetierd2',
    ...
    'wmt_extract_filtered.custtier0 AS filtered_custtier0', 'wmt_extract_filtered.custtierg AS filtered_custtierg', 'wmt_extract_filtered.custtierf AS filtered_custtierf',
    'wmt_extract_filtered.custtiere AS filtered_custtiere', 'wmt_extract_filtered.custtierd2 AS filtered_custtierd2',
