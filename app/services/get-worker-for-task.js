...
const mergeDuplicateOffenderManagers = require('./workers/merge-duplicate-offender-managers')
...
module.exports = function (taskType) {
  switch (taskType) {
    ...
    case taskTypes.MERGE_DUPLICATE_OFFENDER_MANAGERS: return mergeDuplicateOffenderManagers
  }
